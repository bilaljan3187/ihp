...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50 background">
                <img
                    id="background"
                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid items-center grid-cols-2 gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:justify-center lg:col-start-2">
                                <img
                                    src="https://ihp.gkp.pk/wp-content/uploads/2022/05/KP_logo.png"
                                    alt="logo"
                            ...
                            <div className="grid  place-items-center">
                                ...
                                >
                                    ...
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        ...
                                        >
                                            <div className="pt-3 sm:pt-5 lg:pt-0 text-center">
                                                <h2 className="text-xl font-semibold text-blue-900 dark:text-white">
                                                    INTEGRATED HEALTH PROJECT
                                                    VERIFICATION SYSTEM
                                                </h2>
                                                <p className="mt-4 text-sm/relaxed text-blue-900">
                                                    Integration of Health
                                                    Services delivery With
                                                    Special Focus on MNCH, LHW
                        ...
                        <footer className="py-16 text-sm text-center text-black dark:text-white/70">
                            Developed by <b>Bilal Muhammad</b>
                        </footer>
                    </div>
                </div>
            </div>
