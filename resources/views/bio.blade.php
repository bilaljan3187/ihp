...
<head>
    <meta charset="utf-8" />
    <title>IHP - Fingerprint</title>

    <link rel="stylesheet" href="{{ asset('UareUSampleWEB/css/bootstrap-min.css') }}">
    <link rel="stylesheet" href="{{ asset('UareUSampleWEB/app.css') }}" type="text/css" />
</head>
...
<body>
    <div id="Container">
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    <div class="navbar-brand" href="#" style="color: white;">Integrated Health Project Finger
                ...
                <form name="myForm" style ="border : solid grey;padding:5px;">
                    ...
                    <table>
                        ...
                        <tr data-toggle="tooltip" title="Will save data to a Intermediate file">
                            <td>
                                <input type="checkbox" name="Intermediate" value="2" onclick="checkOnly(this)">
                                Feature Set<br>
                            </td>
                        </tr>
                        <tr data-toggle="tooltip" title="Will save data to a .wsq file.">
                            <td>
                                <input type="checkbox" name="Compressed" value="3" onclick="checkOnly(this)">
                                WSQ<br>
                            </td>
                        </tr> --}}
        ...
        <form method="POST" action="{{ route('biometric.save') }}">

            @csrf
            <input type="hidden" name="employee_id" value="{{ $employee->id }}" />
            <input type="hidden" name="biometric_value" value="" id="biometric_value" />
            <input type="submit" class="btn btn-primary" id="formSubmitBtn" value="Upload to Database"
                style="display: none">
    ...
    <script src="{{ asset('UareUSampleWEB/lib/jquery.min.js') }}"></script>
    <script src="{{ asset('UareUSampleWEB/lib/bootstrap.min.js') }}"></script>
    <script src="{{ asset('UareUSampleWEB/scripts/es6-shim.js') }}"></script>
    <script src="{{ asset('UareUSampleWEB/scripts/websdk.client.bundle.min.js') }}"></script>
    <script src="{{ asset('UareUSampleWEB/scripts/fingerprint.sdk.min.js') }}"></script>
    <script src="{{ asset('UareUSampleWEB/app.js') }}"></script>
