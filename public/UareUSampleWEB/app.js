...
$("#save").on("click",function(){
    if(localStorage.getItem("imageSrc") == "" || localStorage.getItem("imageSrc") == null || document.getElementById('imagediv').innerHTML == ""){
        ...
        if(vDiv.children.length < 5){
            ...
            document.getElementById("biometric_value").value = localStorage.getItem("imageSrc"); // added by me
            document.getElementById('formSubmitBtn').style.display = "block"; // addded by me
            document.getElementById('save').disabled = "true"; //added by me
